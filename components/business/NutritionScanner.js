...
export default function NutritionScanner() {
    ...
    const handleBarCodeScanned = async ({ type, data }) => {
        ...
        try {
            ...
            setError(
                'Erreur de connexion à la base OpenFoodFacts.\nVérifie ta connexion internet.',
            );
            setProductData(null);
        } finally {
            setLoading(false);
    ...
    const interpreteNutriScore = (score) => {
        ...
        switch (score.toUpperCase()) {
            ...
            case 'B':
                return '🟢 Bon choix, tu peux en consommer régulièrement.';
            case 'C':
                return '🟡 Moyen : consomme avec modération.';
            case 'D':
                return "🟠 Limite ce produit, surtout avant l'entraînement.";
            case 'E':
                return '🔴 À éviter, surtout en période de compétition !';
            default:
                return 'Nutri-Score inconnu.';
        }
    };

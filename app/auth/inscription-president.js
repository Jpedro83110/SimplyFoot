        ...
        <View style={styles.form}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              <Ionicons name="trophy-outline" size={16} color="#00ff88" /> Informations du club
            </Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              <Ionicons name="person-outline" size={16} color="#00ff88" /> Vos informations de président
            </Text>
          ...
          {clubCreated && clubCode && (
            <View style={styles.clubCodeSection}>
              <Text style={styles.clubCodeTitle}>
                <Ionicons name="key-outline" size={16} color="#00ff88" /> Votre code club
              </Text>
              <View style={styles.clubCodeBox}>
                <Text selectable style={styles.clubCode}>{clubCode}</Text>
                <TouchableOpacity style={styles.copyButton} onPress={copierCodeClub}>
                  <Ionicons name="copy-outline" size={18} color="#000" />
                  <Text style={styles.copyButtonText}>Copier</Text>
                </TouchableOpacity>
              </View>
              <Text style={styles.clubCodeInfo}>
                Partagez ce code avec vos joueurs et coachs pour qu'ils puissent rejoindre le club.
                Vous pourrez configurer les autres informations (site web, réseaux sociaux, etc.) dans votre dashboard.
              </Text>
            </View>
          )}

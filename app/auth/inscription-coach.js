...
import {
  ...
  StyleSheet, Alert, KeyboardAvoidingView, Platform, ScrollView, ActivityIndicator, Image
} from 'react-native';
        ...
        <View style={styles.form}>
          ...
          <View style={styles.diplomaSection}>
            <Text style={styles.sectionTitle}>
              <Ionicons name="school-outline" size={16} color="#00ff88" /> Formations et diplômes
            </Text>

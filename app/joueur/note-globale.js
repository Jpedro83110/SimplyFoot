...
import { View, Text, StyleSheet, ScrollView, ActivityIndicator, Image, Dimensions, Platform } from 'react-native';
...
export default function NoteGlobaleEquipe() {
  ...
  function getBadge(n) {
    ...
    if (n >= 95) return { icon: require('../../assets/badges/platine.png'), label: 'PLATINE', color: '#9eeaff' };
    if (n >= 80) return { icon: require('../../assets/badges/or.png'), label: 'OR', color: '#ffe773' };
    if (n >= 60) return { icon: require('../../assets/badges/argent.png'), label: 'ARGENT', color: '#bfcbd6' };
    return { icon: require('../../assets/badges/bronze.png'), label: 'BRONZE', color: '#d6964c' };
  }
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={[styles.row, isMobile && styles.rowMobile]}>
        ...
        <View style={[styles.noteCard, isMobile && styles.noteCardMobile]}>
          <MaterialCommunityIcons name="emoticon-happy-outline" size={isMobile ? 32 : 40} color="#00ff88" />
        ...
        {/* Bloc Technique */}
        <View style={[styles.noteCard, isMobile && styles.noteCardMobile]}>
          <MaterialCommunityIcons name="soccer" size={isMobile ? 32 : 40} color="#00ff88" />
      ...
      <View style={styles.badgeBlock}>
        ...
        {badge &&
          <View style={styles.badgeVisual}>
            ...
            <Text style={styles.bigNote}>{moyenneGen !== null ? `${moyenneGen}/100` : '—/100'}</Text>
          </View>
        }
      </View>
    </ScrollView>

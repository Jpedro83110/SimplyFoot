    ...
    try {
      ...
      if (json.status === 1) {
        ...
        const productInfo = {
          ...
          nutrition: {
            calories: produit.nutriments?.['energy-kcal_100g'] || produit.nutriments?.['energy-kcal'] || null,
            proteines: produit.nutriments?.['proteins_100g'] || produit.nutriments?.proteins || null,
            glucides: produit.nutriments?.['carbohydrates_100g'] || produit.nutriments?.carbohydrates || null,
            lipides: produit.nutriments?.['fat_100g'] || produit.nutriments?.fat || null,
            fibres: produit.nutriments?.['fiber_100g'] || produit.nutriments?.fiber || null,
            sucres: produit.nutriments?.['sugars_100g'] || produit.nutriments?.sugars || null,
            sel: produit.nutriments?.['salt_100g'] || produit.nutriments?.salt || null,
            sodium: produit.nutriments?.['sodium_100g'] || produit.nutriments?.sodium || null,
          },
          
          // Ingrédients et allergènes
          ingredients: produit.ingredients_text_fr || produit.ingredients_text || "Ingrédients non disponibles",
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.permissionText}>
          Pour scanner les codes-barres nutritionnels, nous avons besoin d'accéder à la caméra.
        </Text>
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.stepMessage}>
        {loading ? "🔍 Analyse nutritionnelle..." : 
         scanned ? "✅ Produit analysé !" : 
      ...
      {productData && !loading && (
        <View style={styles.resultContainer}>
          ...
          <View style={styles.scoresContainer}>
            <View style={[styles.scoreCard, { borderColor: getNutriScoreColor(productData.nutriscore) }]}>
              <Text style={styles.scoreLabel}>Nutri-Score</Text>
              <Text style={[styles.scoreValue, { color: getNutriScoreColor(productData.nutriscore) }]}>
            ...
            {productData.ecoscore && (
              <View style={styles.scoreCard}>
                ...
                <Text style={styles.scoreValue}>{productData.ecoscore.toUpperCase()}</Text>
              </View>
            )}
            {productData.nova && (
              <View style={styles.scoreCard}>
          ...
          {(() => {
            ...
            return (
              <View style={[styles.adviceContainer, { borderLeftColor: advice.color }]}>
                <Text style={styles.adviceTitle}>⚽ Conseils Football</Text>
                <Text style={[styles.adviceIcon, { color: advice.color }]}>{advice.icon}</Text>
            ...
            <View style={styles.nutritionGrid}>
              <View style={styles.nutritionItem}>
                ...
                <Text style={styles.nutritionValue}>
                  {productData.nutrition.calories ? `${productData.nutrition.calories} kcal` : 'N/A'}
                </Text>
              </View>
              <View style={styles.nutritionItem}>

  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.desc}>Scanner un aliment ou une boisson pour obtenir son Nutri-Score, des conseils et son impact sportif.</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={styles.desc}>Astuces nutrition, récupération, études & sport, prévention blessures… (bientôt dispo)</Text>
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#101822', justifyContent: 'center', alignItems: 'center', padding: 20 },
  title: {
    fontSize: 26,
    fontWeight: 'bold',
    marginBottom: 35,

    ...
    try {
      ...
      const demandesAvecJoueurs = await Promise.all(
        (besoins || []).map(async (demande) => {
          console.log(`🔥🔥🔥 JOUEUR: Traitement demande ${demande.id}, joueur_id: ${demande.joueur_id} 🔥🔥🔥`);
          ...
          console.log(`🔥🔥🔥 JOUEUR: Utilisateur trouvé:`, utilisateur, 'erreur:', userErr, '🔥🔥🔥');
      ...
      const demandesEquipe = demandesAvecJoueurs.filter(demande => {
        ...
        console.log(`🔥🔥🔥 JOUEUR: Demande ${demande.id}:`, {
          eventEquipeId,
          joueurEquipeId,
        ...
        {!loading && demandes.length === 0 && (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyInfo}>
              ...
              {'\n'}• Vous êtes dans la même équipe que le demandeur
        ...
        {demandes.map(demande => (
          <View key={demande.id} style={styles.card}>
            ...
            <Text style={styles.statut}>
              📊 Statut : <Text style={{ 
                color: demande.etat === 'en_attente' ? '#ffe44d' : 
                       demande.etat === 'proposition_faite' ? '#00ff88' :
                       demande.etat === 'signe' ? '#00ff88' : '#ffe44d'
              }}>
            ...
            >
              <Text style={{ color: '#111', fontWeight: 'bold' }}>Voir détails & Signer</Text>
            </TouchableOpacity>
          </View>
        ))}
      </ScrollView>

...
export default function Decharge() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.label}>Autorisez-vous le transport par un parent ou membre du staff ?</Text>
      ...
      {accepte && (
        <>
          <Text style={styles.legal}>
            En saisissant vos initiales ci-dessous, vous confirmez votre accord pour que votre enfant soit conduit par un autre parent ou membre du staff. Ceci constitue une signature électronique légalement valable.
          </Text>
      ...
      <TouchableOpacity style={styles.button} onPress={enregistrer}>
        <Text style={styles.buttonText}>{dechargeExistante ? 'Modifier' : 'Enregistrer'} la décharge</Text>
      </TouchableOpacity>
    </View>
  );
}

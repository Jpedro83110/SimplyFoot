...
export default function Abonnement() {
  ...
  const handlePayment = () => {
    if (Platform.OS !== 'web') {
      Alert.alert('Paiement web uniquement', 'Merci de finaliser le paiement depuis un navigateur web.');
      return;
    }
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.payButton} onPress={handlePayment}>
        <Text style={styles.payText}>
          {Platform.OS === 'web' ? '💳 Payer l’abonnement' : '🔒 Paiement uniquement sur le Web'}
        </Text>
      </TouchableOpacity>
    </View>
  );

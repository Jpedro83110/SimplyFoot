                ...
                <View style={styles.legend}>
                    ...
                    <View style={styles.legendItem}>
                        <View
                            style={[
                                styles.square,
                                { backgroundColor: VACANCES_COLORS[zone], borderColor: '#00ff88' },
                            ]}
                        />
                        ...
                        >
                            ...
                            <View style={{ flex: 1 }}>
                                <Text style={styles.nom}>
                                    {selectedAnniv.prenom} {selectedAnniv.nom}{' '}
                                    <Text style={styles.role}>({selectedAnniv.role})</Text>
                                </Text>
                                <Text style={styles.date}>
                                    🎂 {selectedAnniv.date.slice(8, 10)}/
                                    {selectedAnniv.date.slice(5, 7)} — dans{' '}
                                    {selectedAnniv.joursRestants} jour
                                    {selectedAnniv.joursRestants > 1 ? 's' : ''}
                                </Text>
                            </View>
                        </View>
                    </Pressable>
                        ...
                        annivList.map((m) => (
                            <View style={styles.card} key={m.id}>
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={styles.date}>
                                        🎂 {m.date.slice(8, 10)}/{m.date.slice(5, 7)} — dans{' '}
                                        {m.joursRestants} jour{m.joursRestants > 1 ? 's' : ''}
                                    </Text>
                                </View>
                            </View>
                        ))

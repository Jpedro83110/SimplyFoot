...
export const saveToCache = (key, data) => {
  if (!data) return; // Ne stocke rien de vide/erroné
...
export default function useCacheData(key, fetchFunction, ttl = 3600) {
  ...
  // Permet de forcer un refresh externe
      ...
      if (cached && !hasExpired(cached.updated_at, ttl)) {
        ...
        try {
          ...
          if (fresh) {
            ...
            // On ne cache rien si erreur ou absence de data
  ...
  // Fonction refresh qui purge d’abord le cache
